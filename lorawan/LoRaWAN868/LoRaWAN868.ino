...
void setup()
{
    ...
    sendATCMDAndRevice("AT+CDEVEUI=00BB9DA5B97AXXXX\r");
    sendATCMDAndRevice("AT+CAPPEUI=0000000000000001\r");
    sendATCMDAndRevice("AT+CAPPKEY=27DFE264CA33AC1957C005EB48BAXXXX\r");
...
void loop()
{
    ...
    {
        sendATCMDAndRevice("AT+DTRX=1,2,8,4755434b20535444\r");
        delay(100);
    }
